...
// GeneralsX @feature NGMP has multiple transports, so UDPTransport is what Transport
// was: the legacy, direct-connection transport the original game used. Transport is
// now an abstract base class (matches the GeneralsOnline GameClient refactor).
class Transport
{
public:
